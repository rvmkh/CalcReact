...
var AnimationText = function (_React$Component) {
  _inherits(AnimationText, _React$Component);

  function AnimationText(props) {
    _classCallCheck(this, AnimationText);

    var _this = _possibleConstructorReturn(this, (AnimationText.__proto__ || Object.getPrototypeOf(AnimationText)).call(this, props));

    _this.state = { fsize: 10 };
    return _this;
  }
...
function Table(props) {
  return (
    <div>
      <table id="tb2" width="500" bgcolor="lightgreen" align="center" border="3">
        <tr align="center">
...
ReactDOM.render(
  <Table data = { [[1,2], [3,4]] }/>,
  // <Table data = { "PropType TEST" }/>,          // for tst of wrong data-type
  // <Table />,                                    // for test of defaultProps
...
*/
var aa=__webpack_require__(3),ba=__webpack_require__(5),m=__webpack_require__(9),p=__webpack_require__(1),v=__webpack_require__(2),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(4);
